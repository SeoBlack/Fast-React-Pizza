  ...
  return (
    <div className="py-4 px-6 space-y-8">
      ...
      <ul className="divide-stone-200 divide-y border-b border-t">
        {cart.map(item => <OrderItem isLoadingIngredients={fetcher.state === "loading"} item={item} key={item.id} ingredients={fetcher?.data?.find(element => element.id === item.pizzaId)?.ingredients ?? []} />)}
